...
%% Assumptions
% mu1 = 3, nb = 400 Good for Pe and ANP
% mu1 = 3, nb = 10 Good for most
...
nc = 10*100; nos = nc*nb; % no of channels (multiple of 100) and samples
...
%figure(1)
subplot(3,2,1);
plot(SNR_db,APeS(:,1),'g',SNR_db,APeS(:,2),'--r',SNR_db,APeS(:,3),':k','LineWidth',3);
title('P_e(\lambda_{SEF}) for Changing Priors','fontsize',16,'fontweight','b');
...
%figure(2)
subplot(3,2,2);
plot(SNR_db,APeN(:,1),'g',SNR_db,APeN(:,2),'--r',SNR_db,APeN(:,3),':k','LineWidth',3);
title('P_e(\lambda_{NP}) for Changing Priors','fontsize',16,'fontweight','b');
legend( 'P(h_0)=0.7', 'P(h_0)=0.5', 'P(h_0)=0.3');ylim([0 1]);
xlabel('SNR','fontsize',16,'fontweight','b');
ylabel('P_e','fontsize',16,'fontweight','b');
...
%figure(3)
subplot(3,2,3);
plot(SNR_db,APeP(:,1),'g',SNR_db,APeP(:,2),'--r',SNR_db,APeP(:,3),':k','LineWidth',3);
title('P_e(\lambda_{Pe}) for Changing Priors','fontsize',16,'fontweight','b');
legend( 'P(h_0)=0.7', 'P(h_0)=0.5', 'P(h_0)=0.3');ylim([0 1]);
xlabel('SNR','fontsize',16,'fontweight','b');
ylabel('P_e','fontsize',16,'fontweight','b');
...
%figure(4)
subplot(3,2,4);
plot(SNR_db,APeO(:,1),'g',SNR_db,APeO(:,2),'--r',SNR_db,APeO(:,3),':k','LineWidth',3);
title('P_e(\lambda_{Opt}) for Changing Priors','fontsize',16,'fontweight','b');
legend( 'P(h_0)=0.7', 'P(h_0)=0.5', 'P(h_0)=0.3');ylim([0 1]);
xlabel('SNR','fontsize',16,'fontweight','b');
ylabel('P_e','fontsize',16,'fontweight','b');
